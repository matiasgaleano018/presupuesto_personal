    ...
    <body class="sb-nav-fixed">
        <?php
            ...
            if(!empty($_POST['nombre']) && !empty($_POST['monto'])){
                ...
                $sql = "INSERT INTO `movimientos`(`nombre`, `monto`, `cuenta_id`, `categoria_id`, `usuario_id`, `descripcion`, `tipo`, `creadoel`, `fecha`) VALUES ('$nombre', $monto, $cuenta_id, $categoria_id, $usuario_id, '$notas', 'ingreso', NOW(), '$fecha')";

                if($selec->insertar($sql) == 'ok'){
                    $movi = new Movimientos;
                    if($movi->rea_movimiento('ingreso', $cuenta_id, $monto) == 'ok'){
            ...
            if(isset($_POST['cod_edit'])){
                ...
                $ingre_nombre      = $_POST['nombre_edit'];
                $ingre_notas       = !empty($_POST['notas_edit']) ? $_POST['notas_edit'] : "";
                $ingre_cod         = $_POST['cod_edit'];
                $ingre_monto       = !empty($_POST['monto_edit']) ? $_POST['monto_edit'] : "";
                $fecha             = !empty($_POST['fecha_edit']) ? $_POST['fecha_edit'] : date('Y-m-d');
                $cuenta_id         = $_POST['cuenta'];

                $monto  = str_replace(".", "", $ingre_monto);
                $monto  = str_replace(",", ".", $monto);
                $sql_cedit         = "UPDATE `movimientos` SET `nombre`='$ingre_nombre', `fecha`='$fecha',`monto`=$monto,`descripcion`='$ingre_notas',`modificadoel`= NOW() WHERE id = $ingre_cod";


                $movi = new Movimientos;

                if($movi->edi_movimiento('ingreso', $cuenta_id, $monto, $ingre_cod) == 'ok'){
            ...
            if(isset($_POST['cod_eli'])){
                $ingre_cod   = $_POST['cod_eli'];
                $ingre_monto = $_POST['mont_eli'];
                $cuenta_id   = $_POST['cuenta'];
                if($selec->eliminar("DELETE FROM `movimientos` WHERE id = $ingre_cod") == 'ok'){
                    $movi = new Movimientos;
                    if($movi->eli_movimiento('ingreso', $cuenta_id, $ingre_monto) == 'ok'){
                        header("location:ingresos.php");
                    }else{
            ...
            $sql_ingresos = "SELECT `nombre`, `monto`, `cuenta_id`, `categoria_id`, `descripcion`, `tipo`, `fecha`, `modificadoel`, `id` FROM `movimientos` WHERE `usuario_id` = $usuario_id AND `tipo` = 'ingreso' $query ORDER BY creadoel DESC";
            $ingresos = $selec->seleccionar($sql_ingresos);
            $query = "";
                    ...
                    <div class="container">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form action="ingresos.php" method="post">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 col-sm-12 my-2">
                                                                    <div class="form-floating mb-3 mb-md-0">
                                                                        <input class="form-control" id="moneda" type="text" placeholder="Descripción" name="monto" value=""/>
                                                                ...
                                                                <div class="col-lg-4 col-sm-12 my-2">
                                                                    <div class="form-floating mb-3 mb-md-0">
                                                                        <select class="form-select" aria-label="Default select example" name="categoria">
                                                                            <?php
                                                                                $cont_cate = 0;
                                                                                $categorias = $selec->seleccionar("SELECT nombre, id, color FROM categorias WHERE usuario_id = $usuario_id AND tipo = 'ingreso'");
                                                        ...
                                                        <input type="checkbox" name="" id="selecTodoCat" style="display:none;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form action="ingresos.php" method="post" class="d-inline">
                                    <div class="btn-group">
                                ...
                                <form action="../controlador/exportar_ingresos.php" method="post" class="d-inline">
                                    <div class="btn-group">
                                        <input type="text" value="<?php echo $sql_ingresos; ?>" name="select" style="display:none;">
                            ...
                            <table id="datatablesSimple">
                                <thead class="table-dark">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $ingre[0]; ?></td>
                                            <td class="text-end"><?php echo "$simbolo_mone ".number_format($ingre[1], $decimales_mone, ',', '.');?></td>
                                            ...
                                            <td><?php echo $ingre[4]; ?></td>
                                            <td><?php echo $ingre[6]; ?></td>
                                            <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $ingre[8];?>"><i class="fas fa-trash-alt"></i></button></td>
                                            <td><button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $ingre[8];?>"><i class="fas fa-pencil-alt"></i></button></td>

                                            <!-- Modal ELIMINAR -->
                                            <div class="modal fade" id="exampleModal<?php echo $ingre[8];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <form action="ingresos.php" method="post">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="number" value="<?php echo $ingre[8]; ?>" name="cod_eli" style="display:none;">
                                                                <input type="number" value="<?php echo $ingre[1]; ?>" name="mont_eli" style="display:none;">
                                                                <input type="number" value="<?php echo $ingre[2]; ?>" name="cuenta" style="display:none;">
                                            ...
                                            <!-- Modal EDITAR-->
                                            <div class="modal fade" id="staticBackdrop<?php echo $ingre[8];?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="staticBackdropLabel">Editar ingreso</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                        <div class="modal-body">
                                                            <div class="card border-0 ">
                                                                <div class="card-body">
                                                                    ...
                                                                    <form action="ingresos.php" method="post">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-sm-12 my-2">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <input autofocus required class="form-control" id="inputFirstName" type="text" placeholder="Nombre" name="nombre_edit" value="<?php echo $ingre[0]; ?>"/>
                                                                                    <label for="inputFirstName">Nombre</label>
                                                                                    <input type="number" value="<?php echo $ingre[2]; ?>" name="cuenta" style="display:none;">
                                                                                    <input type="number" value="<?php echo $ingre[8]; ?>" name="cod_edit" style="display:none;">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-sm-12 my-2">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <input class="form-control" id="moneda1" type="text" placeholder="Descripción" name="monto_edit" value="<?php echo number_format($ingre[1], $decimales_mone, ',', '.');?>"/>
                                                                                    <label for="inputFirstName">Monto</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-sm-12 my-2">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <select class="form-select" aria-label="Default select example" name="categoria_edit">
                                                                                        ...
                                                                                        ?>
                                                                                            <option <?php if($ingre[3] == $cate[1]){echo "selected";}?> value="<?php echo $cate[1];?>"><?php echo $cate[0];?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                    <label for="inputFirstName">Categoria</label>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-6 col-sm-12 my-2">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <input type="date" class="form-control" name="fecha_edit" id="fecha" value="<?php echo $ingre[6];?>" required>
                                                                                    <label for="fecha">Fecha</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 my-2">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                <textarea class="form-control" id="floatingTextarea2" name="notas_edit" style="height: 90px"><?php echo $ingre[4];?></textarea>
                                                                                <label for="floatingTextarea2">Descripción</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
